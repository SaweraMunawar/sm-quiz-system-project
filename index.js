...
const quiz = await inquirer.prompt([
    ...
    },
    {
        name: "question_3",
        type: "list",
        message: "Q3.Which opertor is commonly used for string concatenation in Typescript?",
        choices: ["+", "-", "*", "/"]
    },
    {
        name: "question_4",
        type: "list",
        message: "Q4.In Typescript, which symbol is commomly used to terminate a statement?",
        choices: [".", ":", ";", ","]
    },
    {
        name: "question_5",
